...
def arg_parse():
    ...
    parser.add_argument('--gpu', default=2, type=int, required=False, help='GPU nums to use')
    parser.add_argument('--workers', default=2, type=int, metavar='N', required=False, help='number of data loading workers')
    parser.add_argument('--batch_size', default=12, type=int,metavar='N', required=False, help='mini-batch size')
    ...
    parser.add_argument('--snapshot', default='./epoch_143_0.3725.pkl', type=str, required=False, help='path to latest checkpoint')
    parser.add_argument('--feature', default='./feature', type=str, required=False, help='path to feature')
    parser.add_argument('--crop_size', default=448, type=int, required=False, help='crop size')
    parser.add_argument('--scale_size', default=512, type=int, required=False, help='the size of the rescale image')
